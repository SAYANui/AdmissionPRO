        ...
        <Card className="relative w-full border-none bg-slate-900 text-slate-50 shadow-2xl overflow-hidden">
          ...
          <CardHeader className="space-y-4 pt-8">
            ...
            <div className="text-center space-y-1">
              <h2 className="text-2xl font-bold tracking-tight text-slate-300">connect with us</h2>
              <CardDescription className="text-slate-400">
                Enter your institution's credentials.
              </CardDescription>
            </div>
          </CardHeader>
          ...
          <CardContent className="grid gap-6">
            <div className="grid gap-2">
              <Label htmlFor="name" className="text-slate-200 ml-1 text-sm">your Name</Label>
              <Input 
                id="name" 
                type="name" 
...
<div className="grid gap-2">
              <Label htmlFor="name" className="text-slate-200 ml-1 text-sm">your institution Name</Label>
              <Input 
                id="insname" 
                type="name" 
...
<div className="grid gap-2">
              ...
              <Input 
                id="email" 
                type="email" 
                placeholder="orgaization@email.com" 
                className="bg-slate-800/50 border-slate-700 text-slate-100 focus-visible:ring-cyan-500 focus-visible:border-cyan-500 transition-all"
              />
            </div>
            ...
            <div className="grid gap-2">
              <Label htmlFor="password" className="text-slate-200 ml-1 text-sm">enter secure password</Label>
          ...
          <CardFooter className="flex flex-col gap-4 pb-8">
            ...
            <div className="flex flex-col items-center gap-2 mt-2">
              <p className="text-xs text-slate-500">
                already signed? 
                <Link to="/admin/login" className="ml-1 text-cyan-400 font-semibold hover:text-cyan-300 transition-colors">
                  login here
                </Link>
              </p>
